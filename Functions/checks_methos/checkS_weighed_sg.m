...
function [passed,n_peaks,checkS,data_filtered] = checkS_weighed_sg(signal, signal_ground,plot_data)
...
%savitz golay filter
[data_filtered,n_peaks] = sG_filter(signal,plot_data, signal_ground);
